...
const Gifts = () => {
    return (
        ...
        <Box sx={{display: "grid", gridTemplateColumns: "1fr 1fr", justifyContent: "center", alignItems: "center", margin: "0 auto", p:1, gap: "10px"}}>
            ...
            <GiftItem categoryImage={"https://d1dmo9iwh0r4qt.cloudfront.net/~/media/ai/main/images/publications/blog/onlinephotonov/photographyphoto.ashx?modified=20181123034155&la=en&hash=061F51B0825AEC249CED44DB5E32432D3FEA05C2"} categoryTitle={"Capture every moment"} />
        </Box>
    </Box>
    )
}
